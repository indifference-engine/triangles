#include "../../../src/blended_triangle.h"
...
int main(int argc, char **argv)
{
  ...
  blended_triangle(
      10, 8, texture_opacities, texture_reds, texture_greens, texture_blues,
      -1.7f, 0.6f, 0.35f, 0.7f, 0.9f, 0.6f, 187.3f, 120.4f, 0.2f,
      1.8f, -2.3f, 0.65f, 0.84f, 0.67f, 0.92f, 152.7f, 120.4f, 0.6f,
      1.8f, 2.1f, 0.81f, 0.93f, 0.88f, 0.41f, 15.3f, 120.4f, 0.4f,
