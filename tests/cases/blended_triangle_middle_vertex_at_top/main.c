...
int main(int argc, char **argv)
{
  ...
  blended_triangle(
      ...
      -1.7f, 0.6f, 0.35f, 0.7f, 0.9f, 0.6f, 24.7f, 120.4f, 0.2f,
      1.8f, -2.3f, 0.65f, 0.84f, 0.67f, 0.92f, 187.2f, 21.8f, 0.6f,
      1.8f, 2.1f, 0.81f, 0.93f, 0.88f, 0.41f, 187.2f, 243.2f, 0.4f,
