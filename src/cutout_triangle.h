#ifndef CUTOUT_TRIANGLE_H

#define CUTOUT_TRIANGLE_H

/**
 * Draws a triangle with cutout transparency.  The texture wraps at each edge
 * and is sampled using nearest-neighbor interpolation without perspective
 * correction.
