#ifndef ADDITIVE_TRIANGLE_H

#define ADDITIVE_TRIANGLE_H

/**
 * Draws an additively blended triangle.  The texture wraps at each edge and is
 * sampled using nearest-neighbor interpolation without perspective correction.
