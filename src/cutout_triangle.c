  ...
  for (int viewport_index = left_index; viewport_index < right_index; viewport_index++)
  {
    ...
    if (source_depth < viewport_depths[viewport_index])
    {
      ...
      if (opacity >= 0.5f)
      {
        ...
        viewport_reds[viewport_index] = accumulators[4] * texture_reds[texture_index];
        viewport_greens[viewport_index] = accumulators[5] * texture_greens[texture_index];
        viewport_blues[viewport_index] = accumulators[6] * texture_blues[texture_index];
      }
    }
